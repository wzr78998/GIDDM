...
parser.add_argument('--dataset', type=str, default='Pavia',
                    help='Houston, pavia')
parser.add_argument('--source_domain', type=str, default='paviaC',
                    help='Houston13, paviaC, W ')
parser.add_argument('--target_domain', type=str, default='paviaU',
                    help='Houston18, paviaU, W ')
parser.add_argument('--seed', type=int, default=7563856, metavar='S',
...
## Iteration Level
parser.add_argument('--warmup_iter', type=int, default=100, metavar='S',
                    help='warmup iteration for posterior inference')
parser.add_argument('--training_iter', type=int, default=20, metavar='S',
                    help='training_iter')
...
parser.add_argument('--no_cuda', action='store_true', default=False,
                    help='disable cuda')
##weight
parser.add_argument('--w_ctu', type=float, default=0.04,
                    help='disable cuda')
...
parser.add_argument('--w_kl', type=float, default=0.1,
                    help='disable cuda')
parser.add_argument('--dim1', type=int, default=383, help='4,5,6,7,8.')
parser.add_argument('--back_num', type=int, default=1, help='4,5,6,7,8.')
parser.add_argument('--dim2', type=int, default=166, help='4,5,6,7,8.')
parser.add_argument('--dim3', type=int, default=130, help='4,5,6,7,8.')
parser.add_argument('--dim4', type=int, default=407, help='4,5,6,7,8.')
parser.add_argument('--dim5', type=int, default=458, help='4,5,6,7,8.')
parser.add_argument('--dim6', type=int, default=190, help='4,5,6,7,8.')
parser.add_argument('--dim7', type=int, default=79, help='4,5,6,7,8.')
parser.add_argument('--dim8', type=int, default=102, help='4,5,6,7,8.')
